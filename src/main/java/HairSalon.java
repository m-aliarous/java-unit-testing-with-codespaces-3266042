...
public class HairSalon {
    ...
    public boolean isOpen(String weekDay) {
        if (!Arrays.stream(weekDays).anyMatch(weekDay::equals)) throw new IllegalArgumentException("only weekdays are valid");
        return Arrays.stream(openingDays).anyMatch(weekDay::equals);
    }
